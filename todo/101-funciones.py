...
# def maximo(a,b,c):
#     if x>y and x>z:
#         return x, print("X es mayor que Y y Z")
#     elif y>x and y>z:
#         return y, print("Y es mayor que X y Z")
#     elif z>x and z>y:
#         return z, print("Z es mayor que X e Y")
#     elif z==y or z==x or x==y:
#         if z==y and z==x and x==y:
#             print("todos los numeros son iguales")
#         elif z==y and z>x:
#             print("Z e Y son los mayores")
#         elif z==x and z>y:
#             print("Z y X son los mayores")
#         elif x==y and x>z:
#             print("X e Y son los mayores")
#     else:
#         return y, print("Algo salio mal")


# #--------------------------
# x=int(input("El número x: "))
# y=int(input("El número y: "))
# z=int(input("El número z: "))
